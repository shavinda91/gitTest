...
*/
	...
	RESERVE_GPIO( UART1,   GPIO_PORT_0,  GPIO_PIN_4,  PID_UART1_TX);
	RESERVE_GPIO( LED_2,   GPIO_PORT_0,  GPIO_PIN_7,  PID_GPIO);
	//RESERVE_GPIO( LED_3,   GPIO_PORT_1,  GPIO_PIN_0,  PID_GPIO);
	RESERVE_GPIO( test, GPIO_PORT_0, GPIO_PIN_0, PID_GPIO);
	RESERVE_GPIO( number, GPIO_PORT_1, GPIO_PIN_0, PID_GPIO);
/*
* Application specific GPIOs reservation. Used only in Development mode (#if DEVELOPMENT_DEBUG)
	RESERVE_GPIO( Sensor_Power, GPIO_PORT_0, GPIO_PIN_0, PID_GPIO);
